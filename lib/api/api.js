...
import { createAuthHook } from './security.js';
...
const authHook = createAuthHook(SESSION_MAX_AGE);
...
fastify.get('/health', async (_request, reply) => {
  ...
  return reply.code(healthy ? 200 : 503).send({
    ...
    schema,
    workersMissing: workerHealth.missing,
...
fastify.register(loginPlugin, { prefix: '/api/login', sessionMaxAge: SESSION_MAX_AGE });
