...
export function availabilityLabelDe(row) {
...
export function furnishingLabelDe(row) {
...
export function petsLabelDe(row) {
...
export function amenitiesLabelDe(amenitiesJson, limit = 8) {
  try {
