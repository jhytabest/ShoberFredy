...
/**
 * Append the market-score line (computed at save time) to the address
 * field, which every adapter renders. Both model families are on the line:
 * ask price, then each model's fair €/m² with its conformal band and delta.
 * Notification-only: the listings are already persisted without the line.
 *
