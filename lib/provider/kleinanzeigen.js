...
function normalize(o) {
  ...
  // Each capture must start with a digit: the paragraphs are concatenated
  // without separators, so a greedy `[\d.,]+` also swallows the comma or dot
  // that ends the preceding phrase ("2 Zimmer,68 m²").
