...
const config = {
  ...
  crawlFields: {
    id: '@data-adid',
    link: '@data-href',
    title: 'h2, h3 | removeNewline | trim',
    price: '.aditem-main--middle--price-shipping--price, p.text-secondary | removeNewline | trim',
    tags: '.aditem-main--middle--tags, p.font-strong.text-onSurfaceSubdued | removeNewline | trim',
    description: '.aditem-main .aditem-main--middle--description, p.text-bodyRegular | removeNewline | trim',
    address: '.aditem-main--top--left, div.text-onSurfaceNonessential > span:first-of-type | removeNewline | trim',
