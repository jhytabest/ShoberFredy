...
import { parseInWorker } from './parser/parser.js';
...
export default class Extractor {
  ...
  parseResponseText = async (crawlContainer, crawlFields, url) => {
    return await parseInWorker(crawlContainer, crawlFields, this.responseText, url);
  };
}
