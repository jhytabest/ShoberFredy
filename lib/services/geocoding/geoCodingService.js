 ...
 * service reports "unavailable" and the pipeline fails open (listings are
 ...
 *                  key, transport); the pipeline fails open and keeps the listing
 */
...
function warnMissingKeyOnce() {
  ...
  logger.warn('GOOGLE_GEOCODING_API_KEY is not set — geocoding is disabled; listings are kept without coordinates.');
}
