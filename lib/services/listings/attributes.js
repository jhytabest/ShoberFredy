...
import { normalizeAttributes } from './standardizedFacts.js';
...
export function listingAttributes(value) {
  if (value && typeof value === 'object' && !Array.isArray(value)) {
    return normalizeAttributes(jsonObject(value.attributes_json ?? value.data));
  }
  return normalizeAttributes(jsonObject(value));
}
