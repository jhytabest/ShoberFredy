...
function enrichRow(row, now, projection) {
  ...
  return {
    ...
    // Extracted since the schema had an `energy` block and used by nothing until
    // now. The certificate is disclosed by law and prices the flat.
    condition: attrs.condition,
    energyClass: attrs.energyClass,
    energyValueKwh: attrs.energyValueKwh,
    latitude,
    longitude,
    x: projected.x,
    y: projected.y,
