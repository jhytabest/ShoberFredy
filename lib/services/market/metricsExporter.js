 ...
 *
 * Serves /metrics (Prometheus text format) plus /health from a read-only
 * database handle. Started in-process by index.js (single-container mode) or
 * standalone via tools/market/marketExporter.js.
 *
