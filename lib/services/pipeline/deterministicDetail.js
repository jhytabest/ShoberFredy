 ...
 * @typedef {{ price: DetNumber, size: DetNumber, rooms: DetNumber, address: DetString }} DeterministicDetail
 */
...
export function extractDeterministicDetail(capture) {
  ...
  // price/size/rooms are kept only because the image dedupe key composes them
  // into an evidence fingerprint; no filter reads them. Nothing here is ever
  // canonical — the extraction is.
