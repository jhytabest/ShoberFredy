    ...
    parameters: {
      ...
      properties: {
        ...
        evidence: {
          ...
          maxItems: 50,
          description:
            'Passage IDs (T1, E2, etc.) supporting known filter-driving facts; the application restores verbatim text. Unknown facts need no passage. Never ' +
          ...
          properties: {
            ...
            warm: nullableNumber(
              ...
              'Warmmiete, the monthly rent including service charges. Null when the advert does not state one ' +
                '— do not calculate it from other charges or estimate a missing amount.',
            ),
