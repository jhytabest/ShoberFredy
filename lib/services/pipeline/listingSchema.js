    ...
    parameters: {
      ...
      properties: {
        ...
        evidence: {
          ...
          maxItems: 50,
          description:
            'Short verbatim passages supporting known filter-driving facts. Unknown facts need no passage. Never ' +
            'invent a quote. status stated when the passage says the fact outright, derived when the fact follows ' +
            'from what the passage says (quote the passage it follows from), contradictory when the advert says ' +
            'both things.',
          items: {
            type: 'object',
            additionalProperties: false,
            ...
            properties: {
              ...
              status: { type: 'string', enum: ['stated', 'derived', 'contradictory'] },
            },
          },
        },
        ...
        rent: {
          ...
          properties: {
            ...
            warm: nullableNumber(
              0,
              50000,
              'Warmmiete, the monthly rent including service charges. Null when the advert does not state one ' +
                'and does not state a Kaltmiete together with every recurring charge on it, heating included — ' +
                'add those up rather than leaving the total out, but never estimate a charge the advert omits.',
            ),
        ...
        amenities: {
          ...
          description:
            'Every amenity the evidence settles, from the fixed vocabulary: present true when the listing has it, ' +
            'present false when the listing rules it out. The evidence settles an amenity when it names it and when ' +
            'the advert says something the amenity follows from — a Baujahr of 1904 settles old_building, ' +
            '"Stuck und Dielen" settles it too. Leave an amenity out entirely when the evidence does not settle it — ' +
            'omission means unknown. Anything outside the vocabulary belongs in comments.',
          items: {
            type: 'object',
            additionalProperties: false,
