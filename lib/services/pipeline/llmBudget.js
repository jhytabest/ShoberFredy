...
function clampReset(resetAtMs, now) {
  ...
  // Bound corrupt provider timestamps without truncating a legitimate reset
  // that crosses midnight shortly after the request.
  const cap = now + 26 * 60 * 60 * 1000;
