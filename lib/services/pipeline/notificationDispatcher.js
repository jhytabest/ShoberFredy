...
/**
 * Continuously dispatch due durable deliveries. Rows that become due together
 * are still grouped as one adapter/provider digest.
 */
export function startNotificationDispatcher() {
  ...
  const intervalMs = positiveEnv('FREDY_NOTIFICATION_INTERVAL_MS', 5000);
