...
/**
 * The evidence a geo verdict was reached from: the address that was geocoded.
 * Two captures of one advert differ in page text constantly and in stated
 * address almost never.
 *
 * @param {import('./listingFilters.js').GeoFacts} facts
 * @returns {string}
 */
export function geoEvidence(facts) {
  return sha256(facts.geoAddress);
}
