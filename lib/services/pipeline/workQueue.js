...
// by being retried later — a paused provider, an unavailable geocoder. Counting
// those against the deferral budget abandons healthy work for an outage
// somewhere else: an outage outlasting MAX_DEFERRALS killed every liveness probe
// for that provider outright, so those listings could never be checked again.
// The age cap still applies and still guarantees termination.
