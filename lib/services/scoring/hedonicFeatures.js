...
export function structuredFeatureFlags(attrs = {}) {
  ...
  return {
    ...
    // The amenity spellings are gone from the extraction vocabulary, but the
    // training corpus reaches back over listings that used them. Reading both
    // keeps every historical row contributing the same feature it always did.
