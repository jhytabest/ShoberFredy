 ...
 * Parsed Kaltmiete/Gesamtmiete lines override the default. Warm-to-cold
 * conversion is deliberately left to market/corpus.js, which owns the shared
 * training/scoring target and can label an imputed value as 'cold_est'.
 */
