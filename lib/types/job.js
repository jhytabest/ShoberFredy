 ...
 * @property {Array<any>} [blacklist] Blacklist terms. Deployment-wide rather
 *   than per job, hydrated from settings when the job is loaded; a job cannot
 *   carry its own list.
 * @property {Array<any>} [provider] Provider configuration list.
 * @property {Array<Object>} [notificationAdapter] Telegram notification configuration.
