...
function isOneOf(word, arr) {
  return firstBlacklistMatch(word, arr) != null;
}

/**
 * Same matching as {@link isOneOf}, but returns the term that fired instead of
 * a bare boolean. Callers persist it so a rejection can be explained — and so
